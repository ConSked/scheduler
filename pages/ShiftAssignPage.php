<?php // $Id: ShiftAssignPage.php 2434 2012-11-30 16:52:35Z ecgero $ Copyright (c) SwiftExpo, LLC. All Rights Reserved.
...
<head>
    ...
    <title>SwiftShift - Shift Assign Page</title>
    ...
    <div id="shiftassignpage_jobaction">
	    ...
	    <table><tr>
	        ...
	        <td>
	            ...
	            {
	                echo swwat_createOption($optionOutList[$j], FALSE);
	            } // $j
	            $optionOutList = NULL;
	            ?>
	            </select>

<?php // $Id: ShiftStatusViewPage.php 2435 2012-11-30 19:56:05Z ecgero $ Copyright (c) SwiftExpo, LLC. All Rights Reserved.
...
<div id="shiftstatusdata_table">
	<form method="POST" id="shiftstatuseditpage_shiftstatusdata"
	      action="ShiftStatusEditPage.php?<?php echo(PARAM_LIST_INDEX.'='.$type.':'.$index); ?>">
	<table>
    	<?php
		if (!is_null($worker->workerid))
		{
			createShiftStatusDataHTMLList($expo->expoid, $station->stationid, $worker->workerid, 'Edit', TRUE);
		}
	    ?>
	</table>
	</form>
</div><!-- shiftstatusdata_table -->

<?php  // $Id: NYCCmail.php 2119 2012-09-21 16:10:11Z cross $ Copyright (c) SwiftExpo, LLC. All Rights Reserved.
...
public static function send($to, $subject, $body)
{
    try
    {
		$headers = 'From: NYCC@swiftexpos.com'."\r\n".'Reply-To: NYCC@swiftexpos.com'."\r\n".'X-Mailer: PHP/' . phpversion();

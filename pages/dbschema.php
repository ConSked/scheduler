<?php  // $Id: dbschema.php 2421 2012-10-30 19:37:58Z ecgero $ Copyright (c) SwiftExpo, LLC. All Rights Reserved.
...
$fileString[] = "worker.sql";
$fileString[] = "workerrole.sql";
$fileString[] = "expo.sql";
$fileString[] = "workerexpo.sql";
$fileString[] = "expoworkerview.sql";
$fileString[] = "station.sql";
$fileString[] = "job.sql";
$fileString[] = "shiftassignment.sql";
$fileString[] = "shiftassignmentrecord.sql";
$fileString[] = "shiftpreference.sql";
$fileString[] = "jobpreference.sql";
$fileString[] = "timepreference.sql";
$fileString[] = "workerview.sql";
$fileString[] = "shiftstatus.sql";
$fileString[] = "invitation.sql";
$fileString[] = "document.sql";

<?php // $Id: OneExpoViewPage.php 2434 2012-11-30 16:52:35Z ecgero $ Copyright (c) SwiftExpo, LLC. All Rights Reserved.
...
if (is_null($expo))
{
    ...
    setExpoOne($expo); // paranoia about some included section
}

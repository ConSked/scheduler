...
<head>
    ...
    <title><?php echo(SITE_NAME); ?> - Invitation File Upload Page</title>
	...
	<div id="invitation_fileupload">
		...
		<table>
            ...
            <tr><td class="fieldTitle">CSV File Format:</td>
                <td><?php swwat_createSelect("CSVFileFormat", array(array("FiveDegrees", "Five Degrees")), "FiveDegrees" , TRUE); ?></td>
            </tr>
            <tr><td></td><td></td></tr>

<?php // $Id: CheckInStationDashboardPage.php 1706 2012-09-05 01:51:53Z preston $ Copyright (c) ConSked, LLC. All Rights Reserved.
include('util/authenticate.php');

require_once('properties/constants.php');
require_once('db/Expo.php');
require_once('db/StationJob.php');
require_once('section/CheckInStationDashboardList.php');
...
<head>
    ...
    <title><?php echo(SITE_NAME); ?> - Check-In Station Dashboard Page</title>
...
<div id="main">
	...
	<div id="checkindashboard_stationlist">
		<?php createCheckInStationDashboardHTMLList($expo->expoid); ?>
	</div><!-- checkindashboard_stationlist -->
</div><!-- main -->

<?php
    $menuItemArray = array();
	$menuItemArray[] = MENU_CHECKIN_WORKER_DASHBOARD;
